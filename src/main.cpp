...
int64 nChainStartTime = 1401578445;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_SHIBE_PROOF_OF_STAKE;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1st june, SHIBE landed on moon.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1401578445; //1400483427
        ...
        assert(block.hashMerkleRoot == uint256("2718e323a6e0036eed4a7297ee51180a85f06611ac5e657a56f7a0e0623f02a6"));
